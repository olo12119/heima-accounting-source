...
chcp 65001 >nul
setlocal
title Heima Accounting 1.3.0 Preview
set "ELECTRON_RUN_AS_NODE="

set "APP_EXE="
for /d %%D in ("%~dp0*1.3.0*") do if exist "%%~fD\win-unpacked\HeimaAccounting.exe" set "APP_EXE=%%~fD\win-unpacked\HeimaAccounting.exe"
